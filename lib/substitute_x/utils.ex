defmodule SubstituteX.Utils do
  @moduledoc false
  ...
  ### Examples
      ...
      iex> SubstituteX.Utils.meets_version_requirement?(:logger, "1.11.0")
      true
  """
  ...
  ### Examples
      ...
      iex> SubstituteX.Utils.compare_dependency_version(:logger, "1.11.0")
      :gt
  """
